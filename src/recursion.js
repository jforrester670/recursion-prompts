...
var createArray = function(str) {
    return str.length === 1 ? [str.charAt(0)] : [str.charAt(0)].concat(createArray(str.slice(1)));
};

// 17. Reverse the order of an array
var reverseArr = function(array) {
    return array.length === 0 ? array : reverseArr(array.slice(1)).concat(array[0]);
};
